...
public class DataService
{
    ...
    public PN OpretPN(int patientId, int laegemiddelId, double antal, DateTime startDato, DateTime slutDato) 
    {
        ...
        if(patient == null)
        {
            throw new ArgumentNullException("Patient ej fundet");
        }
        if(laegemiddel == null)
        {
            throw new ArgumentNullException("Laegemiddel ej fundet");
        }
        if (antal < 0)
        {
        ...
        {
            throw new Exception("Start datoen kan ikke overskride slutdato");
        }
        ...
        DateTime startDato, DateTime slutDato) 
    {
        ...
        if(startDato > slutDato)
        {
            Console.WriteLine("Start datoen kan ikke overskride slutdato");
            throw new Exception("Start datoen kan ikke overskride slutdato");
            
        }

        var df = new DagligFast(startDato, slutDato, laegemiddel, antalMorgen, antalMiddag, antalAften, antalNat);
    ...
    public DagligSkæv OpretDagligSkaev(int patientId, int laegemiddelId, Dosis[] doser, DateTime startDato, DateTime slutDato) 
    {
        ...
        var ds = new DagligSkæv(startDato, slutDato, laegemiddel, doser);
    ...
    public string AnvendOrdination(int id, Dato dato) 
    {
        ...
        {
            throw new Exception("øvbøvbussemand");
        }
	...
	public double GetAnbefaletDosisPerDøgn(int patientId, int laegemiddelId) {
        ...
        if (patient == null)
        {
            throw new Exception("Patient ej fundet");
        }
        if (laegemiddel == null)
        {
            throw new Exception("Laegemiddel ej fundet");
        }
